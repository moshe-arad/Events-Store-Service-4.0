...
@Component
@Scope("prototype")
public class SimpleBackgammonEventsProducerNonJson <T extends BackgammonEvent> implements SimpleProducer, Runnable {

	private final Logger logger = LoggerFactory.getLogger(SimpleBackgammonEventsProducerNonJson.class);
	...
	public SimpleBackgammonEventsProducerNonJson() {
	}
	
	public SimpleBackgammonEventsProducerNonJson(SimpleProducerConfig simpleProducerConfig, String topic) {
