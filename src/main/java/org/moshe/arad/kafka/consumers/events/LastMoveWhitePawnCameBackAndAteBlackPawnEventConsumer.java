...
public class LastMoveWhitePawnCameBackAndAteBlackPawnEventConsumer extends SimpleEventsConsumer {
	...
	public void consumerOperations(ConsumerRecord<String,String> record) {
    	try{
    		LastMoveWhitePawnCameBackAndAteBlackPawnEvent lastMoveWhitePawnCameBackAndAteBlackPawnEvent = convertJsonBlobIntoEvent(record.value());    		
        	logger.info("Event recieved, try to put it in events store...");	                
        	mongoEventsStore.addLastMoveWhitePawnCameBackAndAteBlackPawnEvent(lastMoveWhitePawnCameBackAndAteBlackPawnEvent);
	...
	private LastMoveWhitePawnCameBackAndAteBlackPawnEvent convertJsonBlobIntoEvent(String JsonBlob){
		ObjectMapper objectMapper = new ObjectMapper();
		try {
			return objectMapper.readValue(JsonBlob, LastMoveWhitePawnCameBackAndAteBlackPawnEvent.class);
		} catch (IOException e) {
