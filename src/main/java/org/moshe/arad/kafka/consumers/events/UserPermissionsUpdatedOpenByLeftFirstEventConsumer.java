...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedOpenByLeftFirstEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedOpenByLeftFirstEventConsumer.class);
	
	public UserPermissionsUpdatedOpenByLeftFirstEventConsumer() {
	}
