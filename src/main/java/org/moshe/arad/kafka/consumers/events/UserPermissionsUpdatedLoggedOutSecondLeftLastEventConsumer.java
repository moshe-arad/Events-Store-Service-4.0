...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedLoggedOutSecondLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedLoggedOutSecondLeftLastEventConsumer.class);
	
	public UserPermissionsUpdatedLoggedOutSecondLeftLastEventConsumer() {
	}
