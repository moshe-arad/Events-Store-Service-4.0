...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedWatcherLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedWatcherLeftLastEventConsumer.class);
	
	public UserPermissionsUpdatedWatcherLeftLastEventConsumer() {
	}
