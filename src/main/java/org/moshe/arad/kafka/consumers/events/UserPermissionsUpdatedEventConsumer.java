...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedEventConsumer.class);
	
	public UserPermissionsUpdatedEventConsumer() {
	}
