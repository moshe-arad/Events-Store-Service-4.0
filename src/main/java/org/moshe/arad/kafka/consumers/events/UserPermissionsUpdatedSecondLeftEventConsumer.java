...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedSecondLeftEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedSecondLeftEventConsumer.class);
	
	public UserPermissionsUpdatedSecondLeftEventConsumer() {
	}
