...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAddedWatcherEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAddedWatcherEventConsumer.class);
	
	public UserPermissionsUpdatedAddedWatcherEventConsumer() {
	}
