...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedOpenByLeftEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedOpenByLeftEventConsumer.class);
	
	public UserPermissionsUpdatedOpenByLeftEventConsumer() {
	}
