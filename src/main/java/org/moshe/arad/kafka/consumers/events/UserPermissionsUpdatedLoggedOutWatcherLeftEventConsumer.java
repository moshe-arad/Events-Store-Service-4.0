...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedLoggedOutWatcherLeftEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedLoggedOutWatcherLeftEventConsumer.class);
	
	public UserPermissionsUpdatedLoggedOutWatcherLeftEventConsumer() {
	}
