...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedLoggedOutSecondLeftFirstEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedLoggedOutSecondLeftFirstEventConsumer.class);
	
	public UserPermissionsUpdatedLoggedOutSecondLeftFirstEventConsumer() {
	}
