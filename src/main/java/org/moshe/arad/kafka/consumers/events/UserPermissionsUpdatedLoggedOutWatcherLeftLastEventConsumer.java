...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedLoggedOutWatcherLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedLoggedOutWatcherLeftLastEventConsumer.class);
	
	public UserPermissionsUpdatedLoggedOutWatcherLeftLastEventConsumer() {
	}
