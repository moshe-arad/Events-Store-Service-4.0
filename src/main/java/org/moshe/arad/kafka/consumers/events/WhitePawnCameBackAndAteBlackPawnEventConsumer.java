...
@Component
@Scope("prototype")
public class WhitePawnCameBackAndAteBlackPawnEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(WhitePawnCameBackAndAteBlackPawnEventConsumer.class);
	
	public WhitePawnCameBackAndAteBlackPawnEventConsumer() {
	}
	...
	public void consumerOperations(ConsumerRecord<String,String> record) {
    	try{
        	...
        	mongoEventsStore.addWhitePawnCameBackAndAteBlackPawnEvent(whitePawnCameBackAndAteBlackPawnEvent);
