...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedLoggedOutSecondLeftEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedLoggedOutSecondLeftEventConsumer.class);
	
	public UserPermissionsUpdatedLoggedOutSecondLeftEventConsumer() {
	}
