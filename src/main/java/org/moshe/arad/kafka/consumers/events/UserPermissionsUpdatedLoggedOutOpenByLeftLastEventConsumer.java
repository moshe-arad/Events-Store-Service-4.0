...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedLoggedOutOpenByLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedLoggedOutOpenByLeftLastEventConsumer.class);
	
	public UserPermissionsUpdatedLoggedOutOpenByLeftLastEventConsumer() {
	}
