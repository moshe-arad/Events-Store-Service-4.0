...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedSecondLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedSecondLeftLastEventConsumer.class);
	
	public UserPermissionsUpdatedSecondLeftLastEventConsumer() {
	}
