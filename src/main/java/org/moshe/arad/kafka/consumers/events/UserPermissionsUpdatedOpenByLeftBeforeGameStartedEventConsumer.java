...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedOpenByLeftBeforeGameStartedEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedOpenByLeftBeforeGameStartedEventConsumer.class);
	
	public UserPermissionsUpdatedOpenByLeftBeforeGameStartedEventConsumer() {
	}
