...
@Component
@Scope("prototype")
public class LoggedOutSecondLeftFirstGameStoppedEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(LoggedOutSecondLeftFirstGameStoppedEventConsumer.class);
	
	public LoggedOutSecondLeftFirstGameStoppedEventConsumer() {
	}
