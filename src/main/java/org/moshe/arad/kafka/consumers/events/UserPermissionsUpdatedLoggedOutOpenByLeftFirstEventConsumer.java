...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedLoggedOutOpenByLeftFirstEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedLoggedOutOpenByLeftFirstEventConsumer.class);
	
	public UserPermissionsUpdatedLoggedOutOpenByLeftFirstEventConsumer() {
	}
