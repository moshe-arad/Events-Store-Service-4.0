...
@Component
@Scope("prototype")
public class OpenByLeftFirstGameStoppedEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(OpenByLeftFirstGameStoppedEventConsumer.class);
	
	public OpenByLeftFirstGameStoppedEventConsumer() {
	}
