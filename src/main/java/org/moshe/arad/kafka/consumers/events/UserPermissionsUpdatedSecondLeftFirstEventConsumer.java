...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedSecondLeftFirstEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedSecondLeftFirstEventConsumer.class);
	
	public UserPermissionsUpdatedSecondLeftFirstEventConsumer() {
	}
