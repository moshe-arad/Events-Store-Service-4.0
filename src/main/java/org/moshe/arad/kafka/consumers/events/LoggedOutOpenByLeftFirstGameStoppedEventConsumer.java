...
@Component
@Scope("prototype")
public class LoggedOutOpenByLeftFirstGameStoppedEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(LoggedOutOpenByLeftFirstGameStoppedEventConsumer.class);
	
	public LoggedOutOpenByLeftFirstGameStoppedEventConsumer() {
	}
	...
	public void consumerOperations(ConsumerRecord<String,String> record) {
    	try{
        	...
        	mongoEventsStore.addGameStoppedEvent(gameStoppedEvent);
