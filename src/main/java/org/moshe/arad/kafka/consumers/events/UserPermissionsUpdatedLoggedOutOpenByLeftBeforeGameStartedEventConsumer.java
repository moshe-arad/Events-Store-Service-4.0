...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedLoggedOutOpenByLeftBeforeGameStartedEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedLoggedOutOpenByLeftBeforeGameStartedEventConsumer.class);
	
	public UserPermissionsUpdatedLoggedOutOpenByLeftBeforeGameStartedEventConsumer() {
	}
