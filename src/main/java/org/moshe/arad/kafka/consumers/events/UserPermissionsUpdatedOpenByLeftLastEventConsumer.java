...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedOpenByLeftLastEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedOpenByLeftLastEventConsumer.class);
	
	public UserPermissionsUpdatedOpenByLeftLastEventConsumer() {
	}
