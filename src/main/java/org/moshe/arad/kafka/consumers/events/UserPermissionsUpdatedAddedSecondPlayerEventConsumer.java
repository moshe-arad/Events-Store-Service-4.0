...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedAddedSecondPlayerEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedAddedSecondPlayerEventConsumer.class);
	
	public UserPermissionsUpdatedAddedSecondPlayerEventConsumer() {
	}
	...
	public void consumerOperations(ConsumerRecord<String,String> record) {
    	try{
    		...
    		logger.info("User Permissions Updated Added Watcher Event record recieved, " + record.value());	             
