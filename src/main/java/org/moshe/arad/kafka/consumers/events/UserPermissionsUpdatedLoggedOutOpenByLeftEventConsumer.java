...
@Component
@Scope("prototype")
public class UserPermissionsUpdatedLoggedOutOpenByLeftEventConsumer extends SimpleEventsConsumer {

	@Autowired
	private MongoEventsStore mongoEventsStore;
	
	Logger logger = LoggerFactory.getLogger(UserPermissionsUpdatedLoggedOutOpenByLeftEventConsumer.class);
	
	public UserPermissionsUpdatedLoggedOutOpenByLeftEventConsumer() {
	}
