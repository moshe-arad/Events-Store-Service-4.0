...
public class NewUserJoinedLobbyEventDeserializer implements Deserializer<NewUserJoinedLobbyEvent>{
	...
	@Override
	public NewUserJoinedLobbyEvent deserialize(String arg0, byte[] arg1) {
		// TODO Auto-generated method stub
		return null;
	}
...
//            		2, 2, date, new BackgammonUser(userName, password, firstName, lastName, email, Location.valueOf(location)));
//            
