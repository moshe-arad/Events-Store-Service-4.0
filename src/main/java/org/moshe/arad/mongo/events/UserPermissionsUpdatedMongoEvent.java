...
@Document(collection="UserPermissionsUpdatedEvents")
public class UserPermissionsUpdatedMongoEvent implements IMongoEvent {
	...
	public UserPermissionsUpdatedMongoEvent() {
		
	}

	public UserPermissionsUpdatedMongoEvent(String mongoEventId, UUID uuid, int serviceId, int eventId, Date arrived,
	...
	public String toString() {
		return "UserPermissionsUpdatedMongoEvent [mongoEventId=" + mongoEventId + ", uuid=" + uuid + ", serviceId="
				+ serviceId + ", eventId=" + eventId + ", arrived=" + arrived + ", clazz=" + clazz + ", backgammonUser="
				+ backgammonUser + "]";
	}
	
	public static UserPermissionsUpdatedMongoEvent convertIntoMongoEvent(UserPermissionsUpdatedEvent event) {
		UserPermissionsUpdatedMongoEvent userPermissionsUpdatedEvent = new UserPermissionsUpdatedMongoEvent();
