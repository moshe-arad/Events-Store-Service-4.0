...
@Document(collection="LastMoveBlackPawnTakenOutEvents")
public class LastMoveBlackPawnTakenOutMongoEvent implements IMongoEvent {
	...
	public static LastMoveBlackPawnTakenOutMongoEvent convertIntoMongoEvent(LastMoveBlackPawnTakenOutEvent event) {
		...
		lastMoveBlackPawnTakenOutMongoEvent.setUuid(event.getUuid());
		lastMoveBlackPawnTakenOutMongoEvent.setArrived(event.getArrived());
		lastMoveBlackPawnTakenOutMongoEvent.setClazz(event.getClazz());
		lastMoveBlackPawnTakenOutMongoEvent.setUserName(event.getUserName());
		...
		return lastMoveBlackPawnTakenOutMongoEvent;
	}
