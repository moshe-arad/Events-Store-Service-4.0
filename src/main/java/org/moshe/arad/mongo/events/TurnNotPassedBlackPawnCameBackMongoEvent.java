...
public class TurnNotPassedBlackPawnCameBackMongoEvent implements IMongoEvent {
	...
	public TurnNotPassedBlackPawnCameBackMongoEvent(String mongoEventId, UUID uuid, int serviceId, int eventId,
	...
	public static TurnNotPassedBlackPawnCameBackMongoEvent convertIntoMongoEvent(TurnNotPassedBlackPawnCameBackEvent event) {
		...
		turnNotPassedBlackPawnCameBackMongoEvent.setBackgammonBoardJson(event.getBackgammonBoardJson());
