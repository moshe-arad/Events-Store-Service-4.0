...
public class TurnNotPassedBlackPawnTakenOutMongoEvent implements IMongoEvent {
	...
	public TurnNotPassedBlackPawnTakenOutMongoEvent(String mongoEventId, UUID uuid, int serviceId, int eventId,
	...
	public static TurnNotPassedBlackPawnTakenOutMongoEvent convertIntoMongoEvent(TurnNotPassedBlackPawnTakenOutEvent event) {
		...
		turnNotPassedBlackPawnTakenOutMongoEvent.setBackgammonBoardJson(event.getBackgammonBoardJson());
