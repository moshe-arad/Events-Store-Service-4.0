...
@Document(collection="BlackPawnCameBackEvents")
public class BlackPawnCameBackMongoEvent implements IMongoEvent {
	...
	public BlackPawnCameBackMongoEvent() {
		
	}

	public BlackPawnCameBackMongoEvent(String mongoEventId, UUID uuid, int serviceId, int eventId, Date arrived,
	...
	public String toString() {
		return "BlackPawnCameBackMongoEvent [mongoEventId=" + mongoEventId + ", uuid=" + uuid + ", serviceId="
	...
	public static BlackPawnCameBackMongoEvent convertIntoMongoEvent(BlackPawnCameBackEvent event) {
		BlackPawnCameBackMongoEvent blackPawnCameBackMongoEvent = new BlackPawnCameBackMongoEvent();
		
		blackPawnCameBackMongoEvent.setUuid(event.getUuid());
		blackPawnCameBackMongoEvent.setArrived(event.getArrived());
		blackPawnCameBackMongoEvent.setClazz(event.getClazz());
		blackPawnCameBackMongoEvent.setUserName(event.getUserName());
		blackPawnCameBackMongoEvent.setGameRoomName(event.getGameRoomName());
		blackPawnCameBackMongoEvent.setFrom(event.getFrom());
		blackPawnCameBackMongoEvent.setTo(event.getTo());
		blackPawnCameBackMongoEvent.setBackgammonBoardJson(event.getBackgammonBoardJson());
		blackPawnCameBackMongoEvent.setFirstDice(event.getFirstDice());
		blackPawnCameBackMongoEvent.setSecondDice(event.getSecondDice());
		blackPawnCameBackMongoEvent.setWhite(event.isWhite());
		
		return blackPawnCameBackMongoEvent;
	}
