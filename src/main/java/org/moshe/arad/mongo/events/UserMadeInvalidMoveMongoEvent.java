...
@Document(collection="UserMadeInvalidMoveEvents")
public class UserMadeInvalidMoveMongoEvent implements IMongoEvent {
	...
	public static UserMadeInvalidMoveMongoEvent convertIntoMongoEvent(UserMadeInvalidMoveEvent event) {
		...
		userMadeInvalidMoveMongoEvent.setUuid(event.getUuid());
		userMadeInvalidMoveMongoEvent.setArrived(event.getArrived());
		userMadeInvalidMoveMongoEvent.setClazz(event.getClazz());
		userMadeInvalidMoveMongoEvent.setUserName(event.getUserName());
		...
		return userMadeInvalidMoveMongoEvent;
	}
