...
@Document(collection="loggedOutEvents")
public class LoggedOutMongoEvent implements IMongoEvent {
	...
	public LoggedOutMongoEvent() {
		
	}

	public LoggedOutMongoEvent(String mongoEventId, UUID uuid, int serviceId, int eventId, Date arrived,
	...
	public String toString() {
		return "LoggedOutMongoEvent [mongoEventId=" + mongoEventId + ", uuid=" + uuid + ", serviceId=" + serviceId
				+ ", eventId=" + eventId + ", arrived=" + arrived + ", clazz=" + clazz + ", backgammonUser="
				+ backgammonUser + "]";
	}

	public static LoggedOutMongoEvent convertIntoMongoEvent(LoggedOutEvent event) {
		LoggedOutMongoEvent loggedOutMongoEvent = new LoggedOutMongoEvent();
