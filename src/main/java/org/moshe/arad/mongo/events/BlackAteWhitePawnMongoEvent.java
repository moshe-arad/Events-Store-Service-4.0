...
@Document(collection="BlackAteWhitePawnEvents")
public class BlackAteWhitePawnMongoEvent implements IMongoEvent {
	...
	public BlackAteWhitePawnMongoEvent() {
		
	}

	public BlackAteWhitePawnMongoEvent(String mongoEventId, UUID uuid, int serviceId, int eventId, Date arrived,
	...
	public String toString() {
		return "BlackAteWhitePawnMongoEvent [mongoEventId=" + mongoEventId + ", uuid=" + uuid + ", serviceId="
	...
	public static BlackAteWhitePawnMongoEvent convertIntoMongoEvent(BlackAteWhitePawnEvent event) {
		BlackAteWhitePawnMongoEvent blackAteWhitePawnMongoEvent = new BlackAteWhitePawnMongoEvent();
		
		blackAteWhitePawnMongoEvent.setUuid(event.getUuid());
		blackAteWhitePawnMongoEvent.setArrived(event.getArrived());
		blackAteWhitePawnMongoEvent.setClazz(event.getClazz());
		blackAteWhitePawnMongoEvent.setUserName(event.getUserName());
		blackAteWhitePawnMongoEvent.setGameRoomName(event.getGameRoomName());
		blackAteWhitePawnMongoEvent.setFrom(event.getFrom());
		blackAteWhitePawnMongoEvent.setTo(event.getTo());
		blackAteWhitePawnMongoEvent.setBackgammonBoardJson(event.getBackgammonBoardJson());
		blackAteWhitePawnMongoEvent.setFirstDice(event.getFirstDice());
		blackAteWhitePawnMongoEvent.setSecondDice(event.getSecondDice());
		blackAteWhitePawnMongoEvent.setWhite(event.isWhite());
		
		return blackAteWhitePawnMongoEvent;
	}
