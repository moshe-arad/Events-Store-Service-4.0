...
@Document(collection="TurnNotPassedUserMadeMoveEvents")
public class TurnNotPassedUserMadeMoveMongoEvent implements IMongoEvent {
	...
	public TurnNotPassedUserMadeMoveMongoEvent() {
	...
	public static TurnNotPassedUserMadeMoveMongoEvent convertIntoMongoEvent(TurnNotPassedUserMadeMoveEvent event) {
		TurnNotPassedUserMadeMoveMongoEvent turnNotPassedUserMadeMoveMongoEvent = new TurnNotPassedUserMadeMoveMongoEvent();
		
		turnNotPassedUserMadeMoveMongoEvent.setUuid(event.getUuid());
		turnNotPassedUserMadeMoveMongoEvent.setArrived(event.getArrived());
		turnNotPassedUserMadeMoveMongoEvent.setClazz(event.getClazz());
		turnNotPassedUserMadeMoveMongoEvent.setUserName(event.getUserName());
		...
		return turnNotPassedUserMadeMoveMongoEvent;
	}
