...
public class TurnNotPassedBlackAteWhitePawnMongoEvent implements IMongoEvent {
	...
	public TurnNotPassedBlackAteWhitePawnMongoEvent(String mongoEventId, UUID uuid, int serviceId, int eventId,
	...
	public static TurnNotPassedBlackAteWhitePawnMongoEvent convertIntoMongoEvent(TurnNotPassedBlackAteWhitePawnEvent event) {
		...
		turnNotPassedBlackAteWhitePawnMongoEvent.setBackgammonBoardJson(event.getBackgammonBoardJson());
