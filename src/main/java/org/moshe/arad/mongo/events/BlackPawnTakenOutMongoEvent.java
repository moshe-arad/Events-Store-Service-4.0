...
@Document(collection="BlackPawnTakenOutEvents")
public class BlackPawnTakenOutMongoEvent implements IMongoEvent {
	...
	public BlackPawnTakenOutMongoEvent() {
		
	}

	public BlackPawnTakenOutMongoEvent(String mongoEventId, UUID uuid, int serviceId, int eventId, Date arrived,
	...
	public String toString() {
		return "BlackPawnTakenOutMongoEvent [mongoEventId=" + mongoEventId + ", uuid=" + uuid + ", serviceId="
	...
	public static BlackPawnTakenOutMongoEvent convertIntoMongoEvent(BlackPawnTakenOutEvent event) {
		BlackPawnTakenOutMongoEvent blackPawnTakenOutMongoEvent = new BlackPawnTakenOutMongoEvent();
		
		blackPawnTakenOutMongoEvent.setUuid(event.getUuid());
		blackPawnTakenOutMongoEvent.setArrived(event.getArrived());
		blackPawnTakenOutMongoEvent.setClazz(event.getClazz());
		blackPawnTakenOutMongoEvent.setUserName(event.getUserName());
		blackPawnTakenOutMongoEvent.setGameRoomName(event.getGameRoomName());
		blackPawnTakenOutMongoEvent.setFrom(event.getFrom());
		blackPawnTakenOutMongoEvent.setTo(event.getTo());
		blackPawnTakenOutMongoEvent.setBackgammonBoardJson(event.getBackgammonBoardJson());
		blackPawnTakenOutMongoEvent.setFirstDice(event.getFirstDice());
		blackPawnTakenOutMongoEvent.setSecondDice(event.getSecondDice());
		blackPawnTakenOutMongoEvent.setWhite(event.isWhite());
		
		return blackPawnTakenOutMongoEvent;
	}
