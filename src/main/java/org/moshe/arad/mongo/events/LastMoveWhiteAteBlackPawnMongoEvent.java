...
@Document(collection="LastMoveWhiteAteBlackPawnEvents")
public class LastMoveWhiteAteBlackPawnMongoEvent implements IMongoEvent {
	...
	public LastMoveWhiteAteBlackPawnMongoEvent() {
	...
	public static LastMoveWhiteAteBlackPawnMongoEvent convertIntoMongoEvent(LastMoveWhiteAteBlackPawnEvent event) {
		LastMoveWhiteAteBlackPawnMongoEvent lastMoveWhiteAteBlackPawnMongoEvent = new LastMoveWhiteAteBlackPawnMongoEvent();
		
		lastMoveWhiteAteBlackPawnMongoEvent.setUuid(event.getUuid());
		lastMoveWhiteAteBlackPawnMongoEvent.setArrived(event.getArrived());
		lastMoveWhiteAteBlackPawnMongoEvent.setClazz(event.getClazz());
		lastMoveWhiteAteBlackPawnMongoEvent.setUserName(event.getUserName());
		...
		return lastMoveWhiteAteBlackPawnMongoEvent;
	}
